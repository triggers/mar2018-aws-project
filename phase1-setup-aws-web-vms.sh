...
(
    ...
    (
	$starting_step "Run terraform apply for AWS Web1 and Web2 VMs"
	...
	"$ORGCODEDIR/bin/terraform" apply -auto-approve=true -target=module.web1vm  -target=module.web2vm | tee -a web1.log
    ) ; $iferr_exit
